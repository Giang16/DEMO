...
public class PhiController {
    ...
    public int createPhi(@RequestBody Phi phi){
        ...
        Phi existingPhi = phiRepository.findByTenphiAndDateendAndMoney(tenphi, dateend, money);
        if(existingPhi != null){
    ...
    public int updatePhi(@RequestBody Phi phi){
        ...
        Phi duplicatePhi = phiRepository.findByTenphiAndDateendAndMoney(tenphi, dateend, money);
